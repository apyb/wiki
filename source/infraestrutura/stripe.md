...
![print do dashboard - selecionando todos os associados ativos](infraestrutura/stripe/associados-ativos.png)
...
![print da tela de exportação de assinaturas](infraestrutura/stripe/exportar-assinaturas.png)
...
![print do dashboard - selecionando todos os associados cancelados](infraestrutura/stripe/associados-canceladas.png)
